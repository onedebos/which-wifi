  ...
  return (
    <>
      <div className="px-10 md:flex justify-center m-auto max-w-5xl">
        ...
        <button onClick={resetFilters} className="focus:outline-none">
          <svg
        ...
        <button
          className="lg:w-1/3 md:w-1/2 mx-2 my-2 md:my-0  sm:hidden btn-blue-1000 w-full shadow-md text-center text-white font-semibold py-2 rounded-md flex m-auto justify-center"
